...
public class agregarEquipo extends Activity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.agregar_equipo);
    ...
    class guardar extends AsyncTask<Void, Void, String> {
        ...
        protected void onPreExecute() {
            json_url = "https://www.thinkingmediaco.com/TFg4J1Cb1h/incode/guarda_equipo.php";
        ...
        protected String doInBackground(Void... voids) {
            try {
                ...
                String post_data = URLEncoder.encode("cantidad", "UTF-8") + "=" + URLEncoder.encode(cant, "UTF-8") + "&" + URLEncoder.encode("nombre", "UTF-8") + "=" + URLEncoder.encode(nom, "UTF-8") + "&" +
                        URLEncoder.encode("marca", "UTF-8") + "=" + URLEncoder.encode(marc, "UTF-8") + "&" + URLEncoder.encode("descripcion", "UTF-8") + "=" + URLEncoder.encode(desc, "UTF-8");
        ...
        protected void onPostExecute(String result) {
            ...
            if(result.equals("1"))
            {
                Toast.makeText(agregarEquipo.this, "¡Herramienta agregada", Toast.LENGTH_SHORT).show();

            }
            else if(result.equals("2"))//si hay algo incorrecto en el login
            {
                Toast.makeText(agregarEquipo.this, nom+" "+cant+" "+marc, Toast.LENGTH_SHORT).show();
            }
            Toast.makeText(agregarEquipo.this,result, Toast.LENGTH_SHORT).show();
